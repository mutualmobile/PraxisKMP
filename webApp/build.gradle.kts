    ...
    sourceSets{
        val jsMain by getting {
            dependencies {
                ...
                implementation("org.jetbrains.kotlin-wrappers:kotlin-react-css:17.0.2-pre.284-kotlin-1.6.10")
                implementation("org.jetbrains.kotlin-wrappers:kotlin-react-dom:17.0.2-pre.284-kotlin-1.6.10")
                implementation("org.jetbrains.kotlin-wrappers:kotlin-mui:5.2.5-pre.284-kotlin-1.6.10")
            }
